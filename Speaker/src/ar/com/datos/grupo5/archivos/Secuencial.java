 ...
 * @see ar.com.datos.grupo5.archivos.Archivo
...
public class Secuencial extends Archivo {
	...
	/**
	 * @see ar.ar.com.datos.grupo5.archivos.Archivo#borrar(Registro)
	 * @param registro
	...
	/**
	 * @see ar.ar.com.datos.grupo5.archivos.Archivo#buscar(Registro)
	 * @param registro
	 *            : Es el registro a buscar en el archivo.
	 ...
	 */
	public final byte[] leerBloque(final int offset)
			throws UnImplementedMethodException {
