...
public class RegistroDocumento implements Registro {
	...
	public final byte[] getBytes() {
		...
		try {
			...
			int tamanioTotal = this.longContenido + longDatosAdic + this.longNombreDocumento;
	...
	public final void setContenido(final String datos) {
		...
		this.moreBytes = (long) (this.longContenido + Constantes.SIZE_OF_INT*2 + this.longNombreDocumento); 
	}
